...
/**
 * @title CatX Coin (CATX) Granny said "Don't you dare GO to the Moon!" 
 ...
 * @dev CatX Coin is an upgradeable ERC20 token utilizing access control mechanism, reentrancy protection and other features.  
 */
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        __ERC20_init("CatX", "CATX");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("CatX");
